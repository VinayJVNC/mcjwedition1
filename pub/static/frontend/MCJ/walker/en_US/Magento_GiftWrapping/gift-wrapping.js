...
define([
    ...
    $.widget('mage.giftWrapping', {
        ...
        setWrapping: function (e) {
            ...
            if (this.value) {
                instance.setDesign(designInfo.path, designLayer.find('img'))
                    .setPrice(instance.options.itemsInfo[designBlockId], designInfo, designBlockId, blockId, designLayer);
         ...
         * @pararm {Object} designLayer - object where changes should be made
