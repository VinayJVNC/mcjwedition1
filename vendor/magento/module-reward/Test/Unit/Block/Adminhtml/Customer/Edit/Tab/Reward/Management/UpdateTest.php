...
class UpdateTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->formFactoryMock = $this->getMockBuilder('Magento\Framework\Data\FormFactory')
            ->disableOriginalConstructor()
            ->getMock();
        $this->storeFactoryMock = $this->getMockBuilder('Magento\Store\Model\System\StoreFactory')
            ->setMethods(['create'])
            ->disableOriginalConstructor()
            ->getMock();
        $this->customerRegistryMock = $this->getMockBuilder('Magento\Customer\Model\CustomerRegistry')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->filesystemMock = $this->getMockBuilder('Magento\Framework\Filesystem')
            ->disableOriginalConstructor()
            ->getMock();
        $this->readMock = $this->getMockBuilder('Magento\Framework\Filesystem\Directory\ReadInterface')
            ->getMock();
        $this->validatorMock = $this->getMockBuilder('Magento\Framework\View\Element\Template\File\Validator')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testToHtml()
    {
        ...
        $updateFieldMock = $this->getMockBuilder('Magento\Framework\Data\Form\Element\Checkbox')
            ->setMethods(['setIsChecked'])
            ->disableOriginalConstructor()
            ->getMock();
        /** @var Checkbox|\PHPUnit_Framework_MockObject_MockObject $warningFieldMock */
        $warningFieldMock = $this->getMockBuilder('Magento\Framework\Data\Form\Element\Checkbox')
            ->setMethods(['setIsChecked'])
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $storeMock = $this->getMockBuilder('Magento\Store\Model\System\Store')
            ->disableOriginalConstructor()
            ->getMock();
        /** @var Share|\PHPUnit_Framework_MockObject_MockObject $shareMock */
        $shareMock = $this->getMockBuilder('Magento\Customer\Model\Config\Share')
            ->disableOriginalConstructor()
            ->getMock();
