...
class OptionsTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->checkoutCartFactoryMock = $this->getMockBuilder('\Magento\Checkout\Model\CartFactory')
            ...
            ->getMock();
        $this->taxClassfactoryMock = $this->getMock(
    ...
    public function testCalculatePrice()
    {
        ...
        $taxClass = 'tax_class';
        $currency = 100.00;
        $itemMock = $this->getMock('\Magento\Framework\DataObject', ['setTaxClassId', 'setTaxClassKey'], [], '', false);
        $shipAddressMock = $this->getMock('\Magento\Quote\Model\Quote\Address', [], [], '', false);
        $taxClassKeyMock = $this->getMock(\Magento\Tax\Api\Data\TaxClassKeyInterface::class);
