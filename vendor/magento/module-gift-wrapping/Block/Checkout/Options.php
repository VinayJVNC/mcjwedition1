...
class Options extends \Magento\Framework\View\Element\Template
{
    ...
    public function calculatePrice($item, $basePrice, $shippingAddress, $includeTax = false)
    {
        ...
        $taxClassKey = $this->getTaxClassKeyFactory()->create();
    ...
    /**
     * Get TaxClassKeyInterfaceFactory instance
     * @return \Magento\Tax\Api\Data\TaxClassKeyInterfaceFactory
     */
    private function getTaxClassKeyFactory()
    {
        if (!$this->taxClassKeyFactory) {
            $this->taxClassKeyFactory = \Magento\Framework\App\ObjectManager::getInstance()
                ->get(\Magento\Tax\Api\Data\TaxClassKeyInterfaceFactory::class);
        }
        return $this->taxClassKeyFactory;
    }
}
