...
class GiftRegistryConfigProviderTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->helper = $this->getMockBuilder('Magento\GiftRegistry\Helper\Data')
            ->disableOriginalConstructor()
            ->getMock();
        $this->session = $this->getMockBuilder('Magento\Checkout\Model\Session')
            ->disableOriginalConstructor()
            ->getMock();
        $entityFactory = $this->getMockBuilder('Magento\GiftRegistry\Model\EntityFactory')
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
        $this->entity = $this->getMockBuilder('Magento\GiftRegistry\Model\Entity')
            ->disableOriginalConstructor()
    ...
    public function testGetConfig()
    {
        ...
        $quote = $this->getMockBuilder('Magento\Quote\Model\Quote')->disableOriginalConstructor()->getMock();
