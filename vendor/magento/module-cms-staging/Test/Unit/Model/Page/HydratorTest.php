...
class HydratorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        $this->context = $this->getMockBuilder('Magento\Backend\App\Action\Context')
            ...
            ->getMock();
        $this->postDataProcessor = $this->getMockBuilder('Magento\Cms\Controller\Adminhtml\Page\PostDataProcessor')
            ->disableOriginalConstructor()
            ->getMock();
        $this->eventManager = $this->getMockBuilder('Magento\Framework\Event\ManagerInterface')
            ->getMockForAbstractClass();
        $this->entityRetriever = $this->getMockBuilder('Magento\Staging\Model\Entity\RetrieverInterface')
            ->getMockForAbstractClass();
        $this->page = $this->getMockBuilder('Magento\Cms\Model\Page')
            ->disableOriginalConstructor()
