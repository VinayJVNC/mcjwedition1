...
class PluginTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testBeforeExecute(
        ...
        $pageSaveMock = $this->getMockBuilder('Magento\CmsStaging\Controller\Adminhtml\Page\Update\Save')
        ...
        if ($mode == 'assign') {
            $updateMock = $this->getMockBuilder('Magento\Staging\Api\Data\UpdateInterface')
                ->getMockForAbstractClass();
