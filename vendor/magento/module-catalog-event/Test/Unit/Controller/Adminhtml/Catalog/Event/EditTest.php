...
class EditTest extends \Magento\CatalogEvent\Test\Unit\Controller\Adminhtml\Catalog\AbstractEventTest
{
    ...
    {
        $this->dateResolverMock = $this->getMockBuilder('Magento\CatalogEvent\DateResolver')
            ->disableOriginalConstructor()
            ->setMethods(['convertDate'])
            ->getMock();

        $this->helperMock = $this->getMockBuilder('Magento\CatalogEvent\Helper\Data')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->registryMock = $this->getMockBuilder('Magento\Framework\Registry')
            ->getMock();
        $this->eventFactoryMock = $this->getMockBuilder('Magento\CatalogEvent\Model\EventFactory')
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
        $this->dateTimeMock = $this->getMockBuilder('Magento\Framework\Stdlib\DateTime\Filter\DateTime')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $menuModelMock = $this->getMockBuilder('Magento\Backend\Model\Menu')
            ->disableOriginalConstructor()
            ->getMock();
        $menuModelMock
            ->expects($this->any())
    ...
    public function testExecute($eventId, $prepend, $dateEnd, $dateStart, $modifiedDateEnd, $modifiedDateStart)
    {
        ...
        $this->objectManagerMock->expects($this->any())
            ->method('get')
            ->with('Magento\CatalogEvent\Model\DateResolver')
            ->willReturn($this->dateResolverMock);

        $eventMock->expects($this->any())
            ->method('getDateEnd')
            ->with('Magento\CatalogEvent\Helper\Data')
            ->willReturn($dateEnd);
