...
// @codingStandardsIgnoreEnd
{
    ...
    protected function getMasterConnection()
    {
        if (!isset($this->masterConnection)) {
            $this->masterConnection = $this->builder->build(
                Mysql::class,
                $this->string,
                $this->dateTime,
                $this->logger,
    ...
    protected function getSlaveConnection()
    {
        if (!isset($this->slaveConnection)) {
            $this->slaveConnection = $this->builder->build(
                Mysql::class,
                $this->string,
                $this->dateTime,
                $this->logger,
    ...
    {
        $this->setUseMasterConnection();
        return $this->getMasterConnection()->insertArray($table, $columns, $data);
    }
