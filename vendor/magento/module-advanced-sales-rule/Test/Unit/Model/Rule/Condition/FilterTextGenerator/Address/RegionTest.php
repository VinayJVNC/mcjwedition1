...
use Magento\AdvancedSalesRule\Model\Rule\Condition\FilterTextGenerator\Address\Region;
...
class RegionTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $filterTextGenerator = new Region(['attribute' => 'kiwi']);
    ...
    {
        $filterTextGenerator = new Region(['attribute' => $attrCode]);
