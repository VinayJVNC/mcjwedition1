...
use Magento\AdvancedSalesRule\Model\Rule\Condition\Product\Found;
...
{
    /**
     * @var \Magento\AdvancedSalesRule\Model\Rule\Condition\Product\Found
     */
    protected $model;
    /**
    ...
    protected function setUp()
    {
        ...
        $this->ruleConditionProduct = $this->getMock($className, [], [], '', false);

        $className = '\Magento\AdvancedRule\Helper\CombineCondition';
        $this->conditionHelper = $this->getMock($className, [], [], '', false);

        $this->model = $this->objectManager->getObject(
            'Magento\AdvancedSalesRule\Model\Rule\Condition\Product\Found',
            [
