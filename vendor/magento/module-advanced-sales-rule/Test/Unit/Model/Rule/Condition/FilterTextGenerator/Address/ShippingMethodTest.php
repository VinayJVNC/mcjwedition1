...
use Magento\AdvancedSalesRule\Model\Rule\Condition\FilterTextGenerator\Address\ShippingMethod;
...
class ShippingMethodTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $filterTextGenerator = new ShippingMethod(['attribute' => 'kiwi']);
    ...
    {
        $filterTextGenerator = new ShippingMethod(['attribute' => $attrCode]);
