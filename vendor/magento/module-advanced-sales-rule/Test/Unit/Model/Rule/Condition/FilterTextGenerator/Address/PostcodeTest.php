...
use Magento\AdvancedSalesRule\Model\Rule\Condition\FilterTextGenerator\Address\Postcode;
...
class PostcodeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $filterTextGenerator = new Postcode(['attribute' => 'kiwi']);
    ...
    {
        $filterTextGenerator = new Postcode(['attribute' => $attrCode]);
