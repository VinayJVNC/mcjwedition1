...
{
    const CLASS_NAME = 'Magento\AdvancedSalesRule\Model\Rule\Condition\ConcreteCondition\Address\ShippingMethod';

    const EXPECTED_CLASS_NAME =
        'Magento\AdvancedSalesRule\Model\Rule\Condition\FilterTextGenerator\Address\ShippingMethod';
    ...
    {
        return [
            'array_val_equal_not_filterable' => ['shipping_method_id', '==', [3], false],
            'obj_val_equal_not_filterable' => ['shipping_method_id', '==', new \stdClass, false],
            'null_val_equal_not_filterable' => ['shipping_method_id', '==', null, false],
            'string_val_equal_filterable' => ['shipping_method_id', '==', 'string', true],

            'array_val_not_equal_not_filterable' => ['shipping_method_id', '!=', [3], false],
            'obj_val_not_equal_not_filterable' => ['shipping_method_id', '!=', new \stdClass, false],
            'null_val_not_equal_not_filterable' => ['shipping_method_id', '!=', null, false],
            'string_val_not_equal_filterable' => ['shipping_method_id', '!=', 'string', true],

            'string_val_greater_equal_not_filterable' => ['shipping_method_id', '>=', 'string', false],
            'array_val_greater_equal_not_filterable' => ['shipping_method_id', '>=', [3], false],
        ];
    }
