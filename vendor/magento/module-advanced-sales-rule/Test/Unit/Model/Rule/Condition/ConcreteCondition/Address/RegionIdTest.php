 ...
 * Class RegionIdTest
 */
class RegionIdTest extends \PHPUnit_Framework_TestCase
{
    const CLASS_NAME = 'Magento\AdvancedSalesRule\Model\Rule\Condition\ConcreteCondition\Address\RegionId';

    const EXPECTED_CLASS_NAME =
        'Magento\AdvancedSalesRule\Model\Rule\Condition\FilterTextGenerator\Address\RegionId';
    ...
    {
        return [
            'array_val_equal_not_filterable' => ['region_id', '==', [3], false],
            'obj_val_equal_not_filterable' => ['region_id', '==', new \stdClass, false],
            'null_val_equal_not_filterable' => ['region_id', '==', null, false],
            'string_val_equal_filterable' => ['region_id', '==', 'string', true],

            'array_val_not_equal_not_filterable' => ['region_id', '!=', [3], false],
            'obj_val_not_equal_not_filterable' => ['region_id', '!=', new \stdClass, false],
            'null_val_not_equal_not_filterable' => ['region_id', '!=', null, false],
            'string_val_not_equal_filterable' => ['region_id', '!=', 'string', true],

            'string_val_greater_equal_not_filterable' => ['region_id', '>=', 'string', false],
            'array_val_greater_equal_not_filterable' => ['region_id', '>=', [3], false]
        ];
    }
