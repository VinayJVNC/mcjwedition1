...
class Factory
{
    ...
    public function create($addressCondition)
    {
        ...
        if (isset($this->filterableAttributes[$attribute])) {
            $fullClassName = self::NAMESPACE_STRING . '\\' . $this->filterableAttributes[$attribute];
            ...
            return $this->objectManager->create(
                'Magento\AdvancedSalesRule\Model\Rule\Condition\ConcreteCondition\DefaultCondition'
            );
        }
    }
}
