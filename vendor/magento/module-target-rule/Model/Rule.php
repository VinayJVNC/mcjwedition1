 ...
 *
 * @method \Magento\TargetRule\Model\ResourceModel\Rule _getResource()
 * @method \Magento\TargetRule\Model\ResourceModel\Rule getResource()
...
class Rule extends \Magento\Rule\Model\AbstractModel
{
    ...
    {
        $this->_init('Magento\TargetRule\Model\ResourceModel\Rule');
    }
        ...
        if (is_array($actionArgsList) && isset($actionArgsList['actions'])) {
            foreach ($actionArgsList['actions'] as $actionArgsIndex => $actionArgs) {
                ...
                if (!class_exists($actionArgs['type'])) {
                    throw new LocalizedException(__('Model class name for attribute is invalid'));
                }
