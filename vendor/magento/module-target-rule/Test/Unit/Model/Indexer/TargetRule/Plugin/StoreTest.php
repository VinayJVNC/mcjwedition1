...
{
    /**
     * @var \Magento\TargetRule\Model\Indexer\TargetRule\Plugin\Store
     */
    protected $_model;
    ...
    protected function setUp()
    {
        ...
        $this->_model = new \Magento\TargetRule\Model\Indexer\TargetRule\Plugin\Store(
    ...
    {
        $subjectMock = $this->getMock('\Magento\Store\Model\ResourceModel\Store', [], [], '', false);
