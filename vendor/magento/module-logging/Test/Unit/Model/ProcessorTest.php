...
class ProcessorTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_handlerModelsMock = $this->getMockBuilder(
            'Magento\Logging\Model\Handler\Models'
        )->disableOriginalConstructor()->getMock();
        ...
        $handlerFactoryMock->expects(
            $this->once()
        )->method(
            'create'
        )->will(
            $this->returnValue($this->_controllersMock)
        );
    ...
    {
        $modelMock = $this->getMockBuilder('Magento\Framework\Model\AbstractModel')->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $eventGroupNode = ['expected_models' => ['Magento\Framework\Model\AbstractModel' => []]];
        ...
        $this->_changesMock->expects(
            ...
            $this->equalTo('Magento\Framework\Model\AbstractModel')
        );
    ...
    public function testLogAction()
    {
        ...
        $this->_controllersMock->expects($this->once())->method('postDispatchGeneric')->will($this->returnValue(true));
