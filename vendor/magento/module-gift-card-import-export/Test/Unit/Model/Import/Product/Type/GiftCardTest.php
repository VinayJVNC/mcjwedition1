...
class GiftCardTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $reflection = new \ReflectionClass(\Magento\GiftCardImportExport\Model\Import\Product\Type\GiftCard::class);
        $reflectionProperty = $reflection->getProperty('metadataPool');
        $reflectionProperty->setAccessible(true);
        $reflectionProperty->setValue($this->giftcardModel, $this->metadataPoolMock);
    }
