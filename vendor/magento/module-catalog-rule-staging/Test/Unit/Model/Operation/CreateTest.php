...
class CreateTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->updateRepositoryMock = $this->getMock(\Magento\Staging\Api\UpdateRepositoryInterface::class);
        $this->operationUpdateMock = $this->getMock(
            \Magento\Staging\Model\Operation\Update::class,
            [],
            [],
            '',
            false
        );
        $this->updateFactoryMock = $this->getMock(
        ...
        $this->operationCreateMock = $this->getMock(
            \Magento\Staging\Model\Operation\Create::class,
            [],
            [],
            '',
            false
        ...
        $this->updateMock = $this->getMock(\Magento\Staging\Api\Data\UpdateInterface::class);
        $this->entityMock = $this->getMock('Magento\CatalogRule\Api\Data\RuleInterface');
    ...
    public function testExecute()
    {
        ...
        $id = 1;
        $updateId = 2;
        $updateMock = $this->getMock(\Magento\Staging\Api\Data\UpdateInterface ::class);
        $currentVersion = $this->getMock(\Magento\Staging\Api\Data\UpdateInterface ::class);
        //create update mock
