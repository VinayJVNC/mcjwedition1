...
class DataTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $className = 'Magento\Rma\Helper\Data';
    ...
    public function testGetTrackingPopupUrlBySalesModel($className, $key, $method)
    {
        ...
        $trackMock = $this->getMock(
            $className,
            ['getProtectCode', 'getId', 'getStoreId', 'getEntityId'],
            [],
            '',
            false
        );
        ...
        $storeModelMock = $this->getMock('Magento\Store\Model\Store', [], [], '', false);
    ...
    {
        return [
            ['Magento\Rma\Model\Rma', 'rma_id', 'getId'],
            ['Magento\Rma\Model\Shipping', 'track_id', 'getEntityId']
        ];
    }
}
