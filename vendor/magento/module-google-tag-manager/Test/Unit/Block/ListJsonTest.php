 ...
 */
class ListJsonTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->checkoutCartHelper = $this->getMock('Magento\Checkout\Helper\Cart', [], [], '', false);
        $this->http = $this->getMock('Magento\Framework\App\Request\Http', [], [], '', false);
    ...
    protected function createListJson($initLayer = true)
    {
        $this->layer = $initLayer ?
            $this->getMock('Magento\Catalog\Model\Layer', ['getCurrentCategory'], [], '', false) :
            null;
        $layerResolver = $this->getMock('Magento\Catalog\Model\Layer\Resolver', ['get'], [], '', false);
        ...
        $this->listJson = $this->objectManagerHelper->getObject(
            'Magento\GoogleTagManager\Block\ListJson',
            [
    ...
    public function testGetLoadedProductCollectionForCatalogList()
    {
        ...
        $category = $this->getMock('Magento\Catalog\Model\Category', ['getDisplayMode'], [], '', false);
