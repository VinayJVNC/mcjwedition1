...
class HydratorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->productBuilder = $this->getMockBuilder('Magento\Catalog\Controller\Adminhtml\Product\Builder')
            ->disableOriginalConstructor()
            ->getMock();
        $this->productTypeManager = $this->getMockBuilder('Magento\Catalog\Model\Product\TypeTransitionManager')
            ->disableOriginalConstructor()
            ->getMock();
        $this->versionManager = $this->getMockBuilder('Magento\Staging\Model\VersionManager')
            ->disableOriginalConstructor()
            ->getMock();
        $this->updateRepository = $this->getMockBuilder('Magento\Staging\Api\UpdateRepositoryInterface')
            ->getMockForAbstractClass();
        $this->categoryLinkManagement = $this->getMockBuilder('Magento\Catalog\Api\CategoryLinkManagementInterface')
            ->getMockForAbstractClass();
        $this->entityPersister = $this->getMockBuilder('Magento\Staging\Model\Entity\PersisterInterface')
            ->getMockForAbstractClass();
        $this->entityRetriever = $this->getMockBuilder('Magento\CatalogStaging\Model\Product\Retriever')
            ->disableOriginalConstructor()
            ->getMock();
