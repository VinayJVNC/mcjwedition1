...
class HydratorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->categoryFactory = $this->getMockBuilder('Magento\Catalog\Model\CategoryFactory')
            ...
            ->disableOriginalConstructor()
            ->getMock();
        $this->originalController = $this->getMockBuilder('Magento\Catalog\Controller\Adminhtml\Category\Save')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->category = $this->getMockBuilder('Magento\Catalog\Model\Category')
            ->disableOriginalConstructor()
            ->getMock();
        $this->categoryResource = $this->getMockBuilder('Magento\Catalog\Model\ResourceModel\Category')
            ->disableOriginalConstructor()
            ->getMock();
