...
class BuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->defaultBuilder = $this->getMockBuilder('Magento\Staging\Model\Entity\Builder\DefaultBuilder')
    ...
    {
        $prototype = $this->getMockBuilder('Magento\Catalog\Model\Category')
            ->disableOriginalConstructor()
