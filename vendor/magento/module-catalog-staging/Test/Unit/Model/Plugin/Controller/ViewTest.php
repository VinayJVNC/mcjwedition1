...
class ViewTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->versionManagerMock = $this->getMockBuilder('Magento\Staging\Model\VersionManager')
            ->disableOriginalConstructor()
            ->getMock();
        $this->resourceConnectionMock = $this->getMockBuilder('Magento\Framework\App\ResourceConnection')
            ->disableOriginalConstructor()
            ->getMock();
        $this->previewMock = $this->getMockBuilder('Magento\CatalogStaging\Model\Indexer\Category\Product\Preview')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $viewMock = $this->getMockBuilder('Magento\Catalog\Controller\Category\View')
            ->disableOriginalConstructor()
            ->getMock();
