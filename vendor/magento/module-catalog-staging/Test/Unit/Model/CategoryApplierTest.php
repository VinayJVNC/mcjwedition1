...
class CategoryApplierTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->flatState = $this->getMockBuilder('Magento\Catalog\Model\Indexer\Category\Flat\State')
        ...
        $this->cacheContext = $this->getMockBuilder('Magento\Framework\Indexer\CacheContext')
            ->disableOriginalConstructor()
            ->getMock();
