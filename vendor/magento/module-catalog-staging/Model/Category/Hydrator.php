...
class Hydrator implements HydratorInterface
{
    ...
    public function hydrate(array $requestData)
    {
        ...
        $category->addData($this->prepareCategoryPostData($requestData));
        ...
        if ($validate !== true) {
            foreach ($validate as $code => $error) {
                if ($error === true) {
                    ...
                    throw new LocalizedException(__('Attribute "%1" is required.', $attribute));
                } else {
     ...
     * @return array
     */
    protected function prepareCategoryPostData($data)
    {
