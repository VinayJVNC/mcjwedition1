...
abstract class AbstractItemTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->cmdPhpMock = $this->getMockBuilder('Magento\Support\Model\Backup\Cmd\Php')
        ...
        $this->resourceMock = $this->getMock('Magento\Support\Model\ResourceModel\Backup\Item', [], [], '', false);
