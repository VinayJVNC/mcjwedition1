...
class BackupTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->backupConfigMock = $this->getMock('Magento\Support\Model\Backup\Config', [], [], '', false);
        $this->shellHelperMock = $this->getMock('Magento\Support\Helper\Shell', [], [], '', false);
        $this->cmdPhpFactoryMock = $this->getMockBuilder('Magento\Support\Model\Backup\Cmd\PhpFactory')
            ->setMethods(['create'])
    ...
    {
        $resourceItemMock = $this->getMock('Magento\Support\Model\ResourceModel\Backup\Item', [], [], '', false);
    ...
    protected function initCmdPhpForValidateTest($pathPhp, $scriptName, $resultGenerate)
    {
        ...
        $cmdPhpMock = $this->getMock('Magento\Support\Model\Backup\Cmd\Php', [], [], '', false);
