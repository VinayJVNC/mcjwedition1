...
class ReportTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->productMetadataMock = $this->getMockBuilder('Magento\Enterprise\Model\ProductMetadata')
            ->disableOriginalConstructor()
            ->getMock();
        $this->dateFactoryMock = $this->getMockBuilder('Magento\Framework\Stdlib\DateTime\DateTimeFactory')
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
