 ...
 */
class EnvironmentSectionTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->phpInfoMock = $this->getMockBuilder('Magento\Support\Model\ResourceModel\Report\Environment\PhpInfo')
            ...
            ->getMock();
        $this->osEnvironmentMock = $this->getMock(
        ...
        $this->apacheEnvironmentMock = $this->getMock(
            'Magento\Support\Model\ResourceModel\Report\Environment\ApacheEnvironment',
            [],
            [],
            '',
            false
        );
        $this->mysqlEnvironmentMock = $this->getMock(
            'Magento\Support\Model\ResourceModel\Report\Environment\MysqlEnvironment',
            [],
            [],
            '',
            false
        );
        $this->phpEnvironmentMock = $this->getMock(
            'Magento\Support\Model\ResourceModel\Report\Environment\PhpEnvironment',
            [],
            [],
            '',
            false
