...
class CacheStatusSectionTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->objectConfigMock = $this->getMockBuilder('Magento\Framework\DataObject')
            ->disableOriginalConstructor()
            ->setMethods(['getId', 'getCacheType', 'getDescription', 'getTags', 'getStatus'])
            ->getMock();
        $this->objectLayoutMock = $this->getMockBuilder('Magento\Framework\DataObject')
            ->disableOriginalConstructor()
            ->setMethods(['getId', 'getCacheType', 'getDescription', 'getTags', 'getStatus'])
            ->getMock();
        $this->objectBlockHtmlMock = $this->getMockBuilder('Magento\Framework\DataObject')
            ->disableOriginalConstructor()
            ->setMethods(['getId', 'getCacheType', 'getDescription', 'getTags', 'getStatus'])
            ->getMock();
