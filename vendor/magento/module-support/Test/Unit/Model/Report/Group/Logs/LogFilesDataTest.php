...
class LogFilesDataTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->logsFileData = $this->objectManagerHelper->getObject(
            'Magento\Support\Model\Report\Group\Logs\LogFilesData',
            [
    ...
    public function testGenerate()
    {
        ...
        $fileContent = [
            ...
            . '[2015-09-22 16:25:59] main.CRITICAL: Broken reference: the \'page.breadcrumbs\' tries to reorder itself towards \'notifications\', but their parents are different: \'page.wrapper\' and \'notices.wrapper\' respectively. [] []' . PHP_EOL
