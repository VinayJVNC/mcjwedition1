...
class DataTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->cart = $this->getMockBuilder('Magento\AdvancedCheckout\Model\Cart')
            ->disableOriginalConstructor()
            ->getMock();
        $this->productCollection = $this->getMockBuilder(
            'Magento\AdvancedCheckout\Model\ResourceModel\Product\Collection'
        )
            ->disableOriginalConstructor()
            ->getMock();
        $this->catalogConfig = $this->getMockBuilder('Magento\Catalog\Model\Config')
            ->disableOriginalConstructor()
            ->getMock();
        $this->sessionManager = $this->getMockBuilder('Magento\Framework\Session\SessionManagerInterface')
            ->disableOriginalConstructor()
        ...
        $this->stockRegistry = $this->getMockBuilder('Magento\CatalogInventory\Api\StockRegistryInterface')
            ->disableOriginalConstructor()
            ->getMockForAbstractClass();
        $this->stockHelper = $this->getMockBuilder('Magento\CatalogInventory\Helper\Stock')
            ->disableOriginalConstructor()
            ->getMock();
        $this->quoteItemFactory = $this->getMockBuilder('Magento\Quote\Model\Quote\ItemFactory')
            ->setMethods(['create'])
            ->disableOriginalConstructor()
            ->getMock();
        $this->priceCurrency = $this->getMockBuilder('Magento\Framework\Pricing\PriceCurrencyInterface')
            ->disableOriginalConstructor()
            ->getMockForAbstractClass();
        $this->msrpData = $this->getMockBuilder('Magento\Msrp\Helper\Data')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testGetFailedItems($productOptions)
    {
        ...
        $productItem = $this->getMockBuilder('Magento\Catalog\Model\Product')
            ->setMethods(
                [
                    'getId',
                    'addData',
        ...
        $productUrlModel = $this->getMockBuilder('Magento\Catalog\Model\Product\Url')
            ->disableOriginalConstructor()
            ->getMock();
