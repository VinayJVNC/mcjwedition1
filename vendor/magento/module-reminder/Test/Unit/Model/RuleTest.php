...
class RuleTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->timezoneMock = $this->getMockBuilder('Magento\Framework\Stdlib\DateTime\TimezoneInterface')
            ->getMock();
        $this->rootFactoryMock = $this->getMockBuilder('Magento\Reminder\Model\Rule\Condition\Combine\RootFactory')
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
        $this->collectionFactoryMock = $this->getMockBuilder('Magento\Rule\Model\Action\CollectionFactory')
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
        ...
        $this->storeManagerMock = $this->getMockBuilder('Magento\Store\Model\StoreManagerInterface')
            ->getMock();
        $this->couponFactoryMock = $this->getMockBuilder('Magento\SalesRule\Model\CouponFactory')
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
        $this->dateTimeFactoryMock = $this->getMockBuilder('Magento\Framework\Stdlib\DateTime\DateTimeFactory')
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();
        $this->ruleMock = $this->getMockBuilder('Magento\SalesRule\Model\Rule')
            ->disableOriginalConstructor()
            ->getMock();
        $this->reminderHelperMock = $this->getMockBuilder('Magento\Reminder\Helper\Data')
            ->disableOriginalConstructor()
            ->getMock();
        $this->ruleResourceMock = $this->getMockBuilder('Magento\Reminder\Model\ResourceModel\Rule')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->stateMock = $this->getMockBuilder('Magento\Framework\Translate\Inline\StateInterface')
            ->getMock();
        $this->queryResolverMock = $this->getMockBuilder('Magento\Quote\Model\QueryResolver')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $extensionAttributeFactoryMock = $this->getMock(
    ...
    protected function setSendReminderEmailsPreconditions($label = 'label', $description = 'description')
    {
        ...
        $this->couponMock = $this->getMockBuilder('Magento\SalesRule\Model\Coupon')
            ->disableOriginalConstructor()
            ->getMock();
