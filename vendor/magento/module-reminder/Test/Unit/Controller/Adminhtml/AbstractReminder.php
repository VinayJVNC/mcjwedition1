 ...
 */
abstract class AbstractReminder extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->dataFilter = $this->getMock('Magento\Framework\Stdlib\DateTime\Filter\DateTime', [], [], '', false);
        ...
        $this->timeZoneResolver = $this->getMock(
