...
class Actions extends \Magento\SalesRule\Block\Adminhtml\Promo\Quote\Edit\Tab\Actions
{
    ...
    public function __construct(
        ...
        parent::__construct($context, $registry, $formFactory, $sourceYesno, $ruleActions, $rendererFieldset, $data);
    }
    ...
    protected function _prepareForm()
    {
        ...
        $model->load($entityId);
        $form = $this->addTabToForm($model, 'staging_actions_fieldset', 'salesrulestaging_update_form');
        $this->setForm($form);
        return $this;
    }
}
