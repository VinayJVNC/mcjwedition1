...
class EnterpriseCustomerAddressAttributeSaveTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testEnterpriseCustomerAddressAttributeSave()
    {
        ...
        $this->assertInstanceOf(
            'Magento\CustomerCustomAttributes\Observer\EnterpriseCustomerAddressAttributeSave',
