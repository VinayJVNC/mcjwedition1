...
class BuilderCompositeTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        $this->tMapFactoryMock = $this
            ->getMockBuilder('Magento\Framework\ObjectManager\TMapFactory')
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMock();

        $this->tMapMock = $this->getMockBuilder('Magento\Framework\ObjectManager\TMap')
            ->disableOriginalConstructor()
            ->getMock();

        $this->customerBuilderMock = $this
            ->getMockBuilder('Magento\Payment\Gateway\Request\BuilderInterface')
            ...
            ->with(
                [
                    'array' => [
                        ...
                        'card' => 'Magento\Payment\Gateway\Request\BuilderInterface',
                    ],
                    'type' => BuilderInterface::class
                ]
            )
