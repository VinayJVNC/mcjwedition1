 ...
 */
class TransferIdDataBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->paymentDOMock = $this->getMockBuilder('Magento\Payment\Gateway\Data\PaymentDataObjectInterface')
