...
class ShippingAddressDataBuilderTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testBuild($shippingAddressData, $expectedResult)
    {
        ...
        $order = $this->getMockBuilder('Magento\Payment\Gateway\Data\OrderAdapterInterface')
            ->getMockForAbstractClass();
        $shippingAddress = $this->getMockBuilder('Magento\Payment\Gateway\Data\AddressAdapterInterface')
            ->getMockForAbstractClass();
