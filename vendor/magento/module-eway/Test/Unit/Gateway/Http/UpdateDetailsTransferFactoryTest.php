 ...
 */
class UpdateDetailsTransferFactoryTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $this->config = $this->getMockBuilder('Magento\Payment\Gateway\ConfigInterface')
            ->getMockForAbstractClass();

        $this->transferBuilder = $this->getMockBuilder('Magento\Payment\Gateway\Http\TransferBuilder')
            ->getMock();

        $this->action = $this->getMockBuilder('Magento\Eway\Gateway\Helper\Request\Action')
