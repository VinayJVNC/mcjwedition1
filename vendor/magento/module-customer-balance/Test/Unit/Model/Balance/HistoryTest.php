...
class HistoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->balanceModelMock = $this->getMockBuilder('Magento\CustomerBalance\Model\Balance')
        ...
        $this->customerHelperViewMock = $this->getMockBuilder('\Magento\Customer\Helper\View')
            ->disableOriginalConstructor()
        ...
        $this->creditMemo = $this->getMockBuilder('Magento\Sales\Model\Order\Creditmemo')
            ->disableOriginalConstructor()
            ->getMock();
     ...
     * @expectedExceptionMessage You need a balance to save your balance history.
     */
    ...
    /**
     * @expectedException \Magento\Framework\Exception\LocalizedException
     * @expectedExceptionMessage Unknown balance history action code
     */
