...
class FormTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testToHtml()
    {
        ...
        $notifyFieldMock = $this->getMockBuilder('Magento\Framework\Data\Form\Element\Checkbox')
        ...
        $rendererMock = $this->getMockBuilder('Magento\Backend\Block\Store\Switcher\Form\Renderer\Fieldset\Element')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->layoutMock->expects($this->exactly(2))
            ...
            ->willReturnMap(
                [
                    ['Magento\Backend\Block\Store\Switcher\Form\Renderer\Fieldset\Element', '', [], $rendererMock],
                    [
                        'Magento\CustomerBalance\Block\Adminhtml\Customer\Edit\Tab\Customerbalance\Js',
