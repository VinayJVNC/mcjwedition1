 ...
 *
 * @method \Magento\CustomerBalance\Model\ResourceModel\Balance\History _getResource()
 * @method \Magento\CustomerBalance\Model\ResourceModel\Balance\History getResource()
...
class History extends \Magento\Framework\Model\AbstractModel
{
    ...
    {
        $this->_init('Magento\CustomerBalance\Model\ResourceModel\Balance\History');
    }
    ...
    public function beforeSave()
    {
        ...
        if (!$balance || !$balance->getId()) {
            throw new LocalizedException(__('You need a balance to save your balance history.'));
        }
        ...
        switch ((int)$balance->getHistoryAction()) {
            ...
            default:
                // break intentionally omitted
                throw new LocalizedException(__('Unknown balance history action code'));
        }
