...
class AssignActionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->retriever = $this->getMockBuilder('Magento\Staging\Model\Entity\RetrieverInterface')
            ->getMockForAbstractClass();
        ...
        $this->entityStaging = $this->getMockBuilder(EntityStaging::class)
            ->disableOriginalConstructor()
            ->getMock();
        $this->entityHydratorMock = $this->getMock('Magento\Framework\Model\Entity\Hydrator', [], [], '', false);
     ...
     * @expectedExceptionMessage entityId is required parameter.
     */
