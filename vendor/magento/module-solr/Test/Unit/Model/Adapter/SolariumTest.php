...
class SolariumTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->client = $this->getMockBuilder('Magento\Solr\Model\Client\Solarium')
            ...
            ->getMock();
        $this->clientHelper = $this->getMockBuilder('\Magento\Solr\Helper\Data')
            ->disableOriginalConstructor()
        ...
        $clientFactory = $this->getMockBuilder('\Magento\AdvancedSearch\Model\Client\ClientFactoryInterface')
            ->disableOriginalConstructor()
            ->setMethods(['create'])
            ->getMockForAbstractClass();
        ...
        $this->documentDataMapper = $this->getMockBuilder('\Magento\Solr\Model\Adapter\DocumentDataMapper')
            ->disableOriginalConstructor()
            ->getMock();

        $this->attributeContainer = $this->getMockBuilder('\Magento\Solr\Model\Adapter\Container\Attribute')
            ->disableOriginalConstructor()
            ->getMock();

        $this->resourceIndex = $this->getMockBuilder('\Magento\AdvancedSearch\Model\ResourceModel\Index')
            ->disableOriginalConstructor()
            ->getMock();

        $this->target = $objectManagerHelper->getObject(
            'Magento\Solr\Model\Adapter\Solarium',
            [
    ...
    {
        $documentMock = $this->getMockBuilder('\Solarium\QueryType\Select\Result\Document')
            ->disableOriginalConstructor()
